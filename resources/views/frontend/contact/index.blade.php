            ...
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="contact_message content">
                        ...
                        <ul>
                            <li><i class="fa fa-fax"></i> {{ __('messages.address_label') }}: {{ $settings['site_address'] ?? 'Số 7 Ngõ 91 Lai Xá - Hoài Đức - Thành Phố Hà Nội - Việt Nam' }}</li>
                            <li><i class="fa fa-phone"></i> <a href="tel:{{ str_replace(' ', '', $settings['site_phone'] ?? '0354869999') }}">{{ $settings['site_phone'] ?? '0354869999' }}</a></li>
                            <li><i class="fa fa-envelope-o"></i> <a
                                    href="mailto:{{ $settings['site_email'] ?? 'Elite@gmail.com' }}">{{ $settings['site_email'] ?? 'Elite@gmail.com' }}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                ...
                <div class="col-12">
                    <div class="map-area">
                        <iframe id="googleMap" style="border: none;"
                            src="{{ $settings['store_map_iframe'] ?? 'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3723.6575765790473!2d105.71077797584149!3d21.04638368717544!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3134546536093551%3A0x673199834278e993!2sNg.%2091%20Lai%20X%C3%A1%2C%20Kim%20Chung%2C%20Ho%C3%A0i%20%C4%90%E1%BB%A9c%2C%20H%C3%A0%20N%E1%BB%99i!5e0!3m2!1svi!2s!4v1710000000000!5m2!1svi!2s' }}"
