            ...
            <div class="row">
                <div class="col-12">
                    <div class="section_title">
                        ...
                        <p>Cập nhật những xu hướng thời trang và thông báo mới nhất từ Reid Fashion</p>
                    </div>
                </div>
            </div>
            <div class="row">
                    ...
                    <article class="single_blog">
                        <figure>
                            ...
                            <figcaption class="blog_content">
                                ...
                                <p class="post_desc">Khám phá những bộ sưu tập mới nhất mang đậm phong cách trẻ trung, năng động cho mùa lễ hội năm nay...</p>
                    ...
                    <article class="single_blog">
                        <figure>
                            ...
                            <figcaption class="blog_content">
                                ...
                                <p class="post_desc">Phong cách Minimalism chưa bao giờ lỗi mốt. Hãy cùng Reid Fashion tìm hiểu cách phối đồ chuẩn "soái ca"...</p>
                                <footer class="btn_more">
                                    <a href="#"> Đọc thêm</a>
                                </footer>
                            </figcaption>
                    ...
                    <article class="single_blog">
                        <figure>
                            ...
                            <figcaption class="blog_content">
                                ...
                                <p class="post_desc">Reid Fashion vui mừng thông báo khai trương chi nhánh thứ 5 tại TP. Hồ Chí Minh với nhiều ưu đãi hấp dẫn...</p>
                                <footer class="btn_more">
                                    <a href="#"> Đọc thêm</a>
                                </footer>
                            </figcaption>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="newsletter_text">
                        ...
                        <p>Nhận ngay thông báo về các bộ sưu tập mới và ưu đãi đặc quyền.</p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="newsletter_form">
                        <form id="mc-form" class="mc-form footer-newsletter">
                            <input id="mc-email" type="email" autocomplete="off" placeholder="Địa chỉ email của bạn..." />
