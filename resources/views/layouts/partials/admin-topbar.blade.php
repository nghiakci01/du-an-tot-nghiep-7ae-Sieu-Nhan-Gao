        ...
        <div class="me-auto pc-mob-drp">
            <ul class="list-unstyled">
                ...
                <li class="pc-h-item d-none d-md-inline-flex">
                    <form class="form-search" style="position: relative;">
                        <i class="search-icon">
                            <svg class="pc-icon">
                                <use xlink:href="#custom-search-normal-1"></use>
                            </svg>
                        </i>
                        <input type="search" id="admin-search-input" class="form-control" placeholder="Ctrl + K"
                            autocomplete="off">

                        <div id="search-results" class="dropdown-menu shadow"
                            style="width: 300px; display: none; position: absolute; top: 100%; left: 0;">
            ...
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown lng-dropdown">
                        <a href="#!" class="dropdown-item" data-lng="en"><span>English <small>(UK)</small>
                            </span></a><a href="#!" class="dropdown-item" data-lng="fr"><span>français
                                <small>(French)</small> </span></a><a href="#!" class="dropdown-item"
                            data-lng="ro"><span>Română <small>(Romanian)</small> </span></a><a href="#!"
                ...
                <li class="dropdown pc-h-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                        ...
                        </a><a href="#!" class="dropdown-item"><i class="ti ti-settings"></i> <span>Settings</span>
                        </a><a href="#!" class="dropdown-item"><i class="ti ti-headset"></i> <span>Support</span>
                                                ...
                                                <div class="simplebar-content" style="padding: 0px;">
                                                            ...
                                                            <div
                                                                ...
                                                                <h5 class="mb-0 d-inline-flex align-items-center">
                                                                    <svg class="pc-icon text-muted me-2">
                                                                        <use xlink:href="#custom-notification-outline">
                                                                        </use>
                                                                    </svg>Notification
                                                                </h5>
                                                                <div
                                                    ...
                                                    <a href="#" class="dropdown-item"><span><svg
                                                        ...
                                                        <div class="user-group">
                                                            ...
                                                            <span class="avtar bg-success text-white"><svg
                                                                    class="pc-icon m-0">
                      ...
                      ">
                                                        <div class="card-body">
                                                            ...
                                                            <a href="https://codedthemes.com/item/able-pro-dashboard-templates"
                                                                class="btn btn btn-warning buynowlinks"><svg
                                                                    class="pc-icon me-2">
                                                                    <use xlink:href="#custom-logout-1-outline"></use>
                                                                </svg>
        ...
        <div class="card mb-3">
            <div class="card-body">
                ...
                <p class="text-muted">
                    ...
                    selected by <span class="tf" style="display: none;">Themeforest</span>
