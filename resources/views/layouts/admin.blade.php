...
<html lang="en">
  ...
  <head>
    ...
    <link
      rel="stylesheet"
      href="{{ asset('admin-assets') }}/fonts/inter/inter.css"
      id="main-font-link"
    />
      ...
      <div class="navbar-wrapper">
        <div class="m-header">
          <a href="{{ route('admin.dashboard') }}" class="b-brand text-primary"
            ...
            <img
              src="{{ asset('admin-assets') }}/images/logo-dark.svg"
            ...
            <div class="card-body">
              <div class="d-flex align-items-center">
                ...
                <a
                  ...
                  ><svg class="pc-icon">
                    <use xlink:href="#custom-sort-outline"></use></svg
                ></a>
              </div>
          ...
          <ul class="pc-navbar">
            ...
            <li class="pc-item">
              <a href="../widget/w_statistics.html" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Statistics"
                  >Statistics</span
                ></a
              >
            </li>
            <li class="pc-item">
              <a href="../widget/w_data.html" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Data">Data</span></a
              >
            </li>
            <li class="pc-item">
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Online Courses"
                  >Online Courses</span
                >
                <span class="pc-arrow"
            ...
            <li class="pc-item">
              <a
                ...
                ><span class="pc-mtext" data-i18n="Components"
                  >Components</span
                ></a
              >
            </li>
            <li class="pc-item">
              <a href="../elements/animation.html" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Animation"
                  >Animation</span
                ></a
              >
            </li>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Form Elements"
                  >Forms Elements</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Form Plugins"
                  >Forms Plugins</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Text Editor"
                  >Text Editors</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Form Layouts"
                  >Form Layouts</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="File Upload"
                  >File upload</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item">
              <a href="../forms/form-validation.html" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Form Validation"
            ...
            <li class="pc-item">
              <a href="../forms/image_crop.html" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Images Cropper"
                  >Image cropper</span
                ></a
              >
            </li>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Bootstrap Table"
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Vanilla table"
                  >Vanilla Table</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item pc-hasmenu">
              ...
              <ul class="pc-submenu">
                ...
                <li class="pc-item">
                  <a class="pc-link" href="../table/dt_api.html" data-i18n="API"
                    >API</a
                  >
                </li>
                <li class="pc-item">
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="DT extensions"
                  >DT extensions</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item pc-caption">
              ...
              <svg class="pc-icon"><use xlink:href="#custom-graph"></use></svg>
            </li>
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ><span class="pc-micon"
            ...
            <li class="pc-item">
              <a href="../application/file-manager.html" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="File manager"
                  >File manager</span
                ></a
              >
            </li>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Authentication"
                  >Authentication</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Maintenance"
                  >Maintenance</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
            ...
            <li class="pc-item">
              <a href="../pages/contact-us.html" class="pc-link" target="_blank"
                ...
                ><span class="pc-mtext" data-i18n="Contact Us"
                  >Contact us</span
                ></a
              >
            </li>
            ...
            <li class="pc-item">
              <a href="{{ route('admin.dashboard') }}" class="pc-link" target="_blank"
                ><span class="pc-micon"
                  ><svg class="pc-icon">
            ...
            <li class="pc-item pc-hasmenu">
              <a href="#!" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Menu levels"
                  >Menu levels</span
                ><span class="pc-arrow"
                  ><i data-feather="chevron-right"></i></span
              ></a>
              <ul class="pc-submenu">
                <li class="pc-item">
                  <a class="pc-link" href="#!" data-i18n="Level 2.1"
                    >Level 2.1</a
                  >
                </li>
                <li class="pc-item pc-hasmenu">
                  ...
                  <ul class="pc-submenu">
                    <li class="pc-item">
                      <a class="pc-link" href="#!" data-i18n="Level 3.1"
                        >Level 3.1</a
                      >
                    </li>
                    <li class="pc-item">
                      <a class="pc-link" href="#!" data-i18n="Level 3.2"
                        >Level 3.2</a
                      >
                    </li>
                    <li class="pc-item pc-hasmenu">
                      ...
                      <ul class="pc-submenu">
                        <li class="pc-item">
                          <a class="pc-link" href="#!" data-i18n="Level 4.1"
                            >Level 4.1</a
                          >
                        </li>
                        <li class="pc-item">
                          <a class="pc-link" href="#!" data-i18n="Level 4.2"
                            >Level 4.2</a
                          >
                        </li>
                      </ul>
            ...
            <li class="pc-item">
              <a href="../other/sample-page.html" class="pc-link"
                ...
                ><span class="pc-mtext" data-i18n="Sample Page"
                  >Sample page</span
                ></a
              >
            </li>
          ...
          <ul class="list-unstyled">
            <li class="dropdown pc-h-item">
              <a
                ...
                aria-expanded="false"
                ><svg class="pc-icon">
                  <use xlink:href="#custom-sun-1"></use></svg
              ></a>
            ...
            <li class="dropdown pc-h-item">
              <a
                ...
                aria-expanded="false"
                ><svg class="pc-icon">
                  <use xlink:href="#custom-language"></use></svg
              ></a>
              <div
                class="dropdown-menu dropdown-menu-end pc-h-dropdown lng-dropdown"
              >
                <a href="#!" class="dropdown-item" data-lng="en"
                  ><span>English <small>(UK)</small> </span></a
                ><a href="#!" class="dropdown-item" data-lng="fr"
                  ><span>français <small>(French)</small> </span></a
                ><a href="#!" class="dropdown-item" data-lng="ro"
                  ><span>Română <small>(Romanian)</small> </span></a
                ><a href="#!" class="dropdown-item" data-lng="cn"
                  ><span>中国人 <small>(Chinese)</small></span></a
                >
              </div>
            </li>
            <li class="dropdown pc-h-item">
              <a
                ...
                aria-expanded="false"
                ><svg class="pc-icon">
                  <use xlink:href="#custom-setting-2"></use></svg
              ></a>
              <div class="dropdown-menu dropdown-menu-end pc-h-dropdown">
                <a href="#!" class="dropdown-item"
                  ><i class="ti ti-user"></i> <span>My Account</span> </a
                ><a href="#!" class="dropdown-item"
                  ><i class="ti ti-settings"></i> <span>Settings</span> </a
                ><a href="#!" class="dropdown-item"
                  ><i class="ti ti-headset"></i> <span>Support</span> </a
                ><a href="#!" class="dropdown-item"
                  ><i class="ti ti-lock"></i> <span>Lock Screen</span> </a
                ><a href="#!" class="dropdown-item"
                  ><i class="ti ti-power"></i> <span>Logout</span></a
                >
              </div>
            </li>
            <li class="pc-h-item">
              <a
                ...
                ><svg class="pc-icon">
                  <use xlink:href="#custom-flash"></use></svg
              ></a>
            </li>
            <li class="dropdown pc-h-item">
              <a
            ...
            <li class="dropdown pc-h-item header-user-profile">
              <a
                ...
                aria-expanded="false"
                ><img
                  src="{{ asset('admin-assets') }}/images/user/avatar-2.jpg"
                  alt="user-image"
                  class="user-avtar"
              /></a>
              <div
                  ...
                  >
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <span
                          ><a
                            ...
                            class="__cf_email__"
                            data-cfemail="b9dad8cbcad6d797ddd8cbcbd0d7f9dad6d4c9d8d7c097d0d6"
                            >[email&#160;protected]</a
                          ></span
                        >
                      </div>
                        ...
                        >
                          <h5 class="mb-0 d-inline-flex align-items-center">
                            <svg class="pc-icon text-muted me-2">
                              <use
                                xlink:href="#custom-notification-outline"
                              ></use></svg
                            >Notification
                          </h5>
                          <div
                    ...
                    ><a href="#" class="dropdown-item"
                      ...
                      <div class="user-group">
                        ...
                        <span class="avtar bg-success text-white"
                          ><svg class="pc-icon m-0">
                            <use xlink:href="#custom-user"></use></svg
                        ></span></div></a
                    ><a href="#" class="dropdown-item"
                      ><span
                        ><svg class="pc-icon text-muted me-2">
                      ...
                      <div class="user-group">
                        <span class="avtar bg-primary text-white"
                          ><svg class="pc-icon m-0">
                            <use xlink:href="#custom-add-outline"></use></svg
                        ></span></div
                    ></a>
                    <hr class="border-secondary border-opacity-50" />
                    ...
                    >
                      <div class="card-body">
                        <div class="user-group">
                          ...
                          />
                          <img
                            src="{{ asset('admin-assets') }}/images/user/avatar-3.jpg"
                            alt="user-image"
                            class="avtar"
                          />
                          <img
                            src="{{ asset('admin-assets') }}/images/user/avatar-4.jpg"
                            alt="user-image"
                            class="avtar"
                          />
                          <img
                            src="{{ asset('admin-assets') }}/images/user/avatar-5.jpg"
                            alt="user-image"
                            class="avtar"
                          />
                          <span class="avtar bg-light-primary text-primary"
      ...
      <div class="offcanvas-body">
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <img
              src="{{ asset('admin-assets') }}/images/layout/img-announcement-1.png"
              alt="img"
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <a href="https://1.envato.market/zNkqj6" target="_blank"
              ><img
                src="{{ asset('admin-assets') }}/images/layout/img-announcement-2.png"
                alt="img"
                class="img-fluid"
            /></a>
          </div>
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <img
              src="{{ asset('admin-assets') }}/images/layout/img-announcement-3.png"
              alt="img"
              class="img-fluid"
            />
          </div>
        ...
        <div class="card mb-3">
          <div class="card-body">
            ...
            <img
              src="{{ asset('admin-assets') }}/images/layout/img-announcement-4.png"
              alt="img"
              class="img-fluid"
            />
          </div>
        ...
        <div class="row">
          <div class="col my-1">
            <p class="m-0">
              ...
              <a href="https://www.phoenixcoded.net/" target="_blank"
                >Phoenixcoded</a
              >
            </p>
          </div>
            ...
            <li class="list-group-item">
              ...
              <div class="theme-main-layout d-flex align-center gap-1 w-100">
                <a
                  ...
                  data-value="vertical"
                  ><img
                    src="{{ asset('admin-assets') }}/images/customizer/caption-on.svg"
                    alt="img"
                    class="img-fluid"
                  /> </a
                ><a
                  ...
                  ><img
                    src="{{ asset('admin-assets') }}/images/customizer/horizontal.svg"
                    alt="img"
                    class="img-fluid"
                  /> </a
                ><a
                  ...
                  ><img
                    src="{{ asset('admin-assets') }}/images/customizer/color-header.svg"
                    alt="img"
                    class="img-fluid"
                  /> </a
                ><a
                  ...
                  data-value="compact"
                  ><img
                    src="{{ asset('admin-assets') }}/images/customizer/compact.svg"
                    alt="img"
                    class="img-fluid"
                  /> </a
                ><a
                  ...
                  data-value="tab"
                  ><img
                    src="{{ asset('admin-assets') }}/images/customizer/tab.svg"
                    alt="img"
                    class="img-fluid"
                /></a>
              </div>
              ...
              <div class="row theme-color theme-nav-caption">
                ...
                <div class="col-6">
                  <div class="d-grid">
                    ...
                    >
                      <img
                        src="{{ asset('admin-assets') }}/images/customizer/caption-off.svg"
                        alt="img"
                        class="img-fluid"
                      />
                    </button>
                ...
                <div class="row theme-color theme-direction">
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="{{ asset('admin-assets') }}/images/customizer/ltr.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
                  ...
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="{{ asset('admin-assets') }}/images/customizer/rtl.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
                ...
                <div class="row theme-color theme-container">
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="{{ asset('admin-assets') }}/images/customizer/full.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
                  ...
                  <div class="col-6">
                    <div class="d-grid">
                      ...
                      >
                        <img
                          src="{{ asset('admin-assets') }}/images/customizer/fixed.svg"
                          alt="img"
                          class="img-fluid"
                        />
                      </button>
