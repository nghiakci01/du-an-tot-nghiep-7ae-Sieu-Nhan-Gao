                ...
                <div class="row">
                  <div class="col-sm-6">
                    <div class="p-4">
                      ...
                      <a
                        ...
                        class="btn btn-outline-light btn-buy"
                        >Download</a
                      >
                    </div>
                  </div>
                  <div class="col-sm-6 text-center">
                    <div class="img-welcome-banner">
                      <img
                        src="{{ asset('admin-assets/images/widget/welcome-banner.png') }}"
                        alt="img"
                        class="img-fluid"
                      />
                    </div>
              ...
              <div class="card-body">
                ...
                <div class="bg-body p-3 mt-3 rounded">
                  <div class="mt-3 row align-items-center">
                    <div class="col-7"><div id="all-earnings-graph"></div></div>
                    <div class="col-5">
          ...
          <div class="col-md-6 col-xxl-3">
            <div class="card">
              <div class="card-body">
                ...
                <div class="bg-body p-3 mt-3 rounded">
                  <div class="mt-3 row align-items-center">
                    <div class="col-7"><div id="page-views-graph"></div></div>
                    <div class="col-5">
          ...
          <div class="col-md-6 col-xxl-3">
            <div class="card">
              <div class="card-body">
                ...
                <div class="bg-body p-3 mt-3 rounded">
                  <div class="mt-3 row align-items-center">
                    <div class="col-7"><div id="total-task-graph"></div></div>
                    <div class="col-5">
          ...
          <div class="col-md-6 col-xxl-3">
            <div class="card">
              <div class="card-body">
                ...
                <div class="bg-body p-3 mt-3 rounded">
                  <div class="mt-3 row align-items-center">
                    <div class="col-7"><div id="download-graph"></div></div>
                    <div class="col-5">
                ...
                >
                  <div class="user-group able-user-group">
                    ...
                    <img
                      ...
                      class="avtar"
                    />
                    <span class="avtar bg-light-primary text-primary text-sm"
                      >+2</span
                    >
                  </div>
                  <a
                    href="#"
                    class="avtar avtar-s btn btn-primary rounded-circle"
                  ...
                  <div class="col-md-6">
                    <div class="d-grid">
                      <button class="btn btn-outline-secondary d-grid">
                        <span class="text-truncate w-100"
                          >View all Transaction History</span
                        >
                      </button>
                    </div>
                  </div>
