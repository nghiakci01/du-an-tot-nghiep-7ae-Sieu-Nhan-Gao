            ...
            <div class="card-body">
                @if($coupon->used_count > 0)
                    <div class="alert alert-warning">
                        ...
                        Mã này đã được sử dụng <strong>{{ $coupon->used_count }}</strong> lần. Hãy cẩn thận khi chỉnh sửa.
                    </div>
                @endif
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @error('usage_limit')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <small class="form-text text-muted">Đã dùng: {{ $coupon->used_count }} lần</small>
                            </div>
                        </div>
