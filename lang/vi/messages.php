...
return [
    ...
    'order_success_message' => 'Cảm ơn bạn đã mua hàng tại FashionStore.',
    ...
    'shipping_address' => 'Địa chỉ giao hàng',
    'bank_transfer_instructions' => 'Hướng dẫn chuyển khoản',
    'bank_name' => 'Ngân hàng',
    'account_number' => 'Số tài khoản',
    'account_holder' => 'Chủ tài khoản',
    'transfer_content' => 'Nội dung chuyển khoản',
    'copy' => 'Sao chép',
    'bank_transfer_note' => 'Vui lòng hoàn tất chuyển khoản và gửi cho chúng tôi bằng chứng thanh toán.',
    'next_steps' => 'Các bước tiếp theo',
    'next_step_1' => 'Chúng tôi đã nhận được đơn hàng và sẽ xử lý trong thời gian sớm nhất.',
    'next_step_2' => 'Bạn sẽ nhận được email xác nhận với chi tiết đơn hàng.',
    'next_step_3' => 'Chúng tôi sẽ thông báo khi đơn hàng được giao.',
    'next_step_bank' => 'Sau khi xác nhận thanh toán, chúng tôi sẽ xử lý đơn hàng của bạn.',
