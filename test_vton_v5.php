<?php
// Standalone Kolors Virtual Try-on Test Script v5
...
echo "Starting Kolors Virtual Try-on Test v5...\n";
...
// Kolors Space URL
$url = 'https://kwai-kolors-kolors-virtual-try-on.hf.space/call/predict';
...
$payload = [
    'data' => [
        ...
        42,     // Seed
        true,   // is_checked (might be auto-mask or something else)
    ]
];

echo "Sending request to Kolors...\n";
try {
