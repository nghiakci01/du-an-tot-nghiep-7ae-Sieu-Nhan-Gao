...
│   ├── 11-lien-he.md
│   └── 12-kiem-tra-ton-kho-thanh-toan.md
...
| [05-thanh-toan.md](frontend/05-thanh-toan.md) | Checkout, VNPAY, chuyển khoản QR ngân hàng, thanh toán bằng ví |
| [06-tai-khoan.md](frontend/06-tai-khoan.md) | Tài khoản cá nhân, đơn hàng, hoàn trả, ví điện tử, tài khoản ngân hàng |
...
| [12-kiem-tra-ton-kho-thanh-toan.md](frontend/12-kiem-tra-ton-kho-thanh-toan.md) | Kiểm tra tồn kho thời gian thực khi thanh toán |
...
| File | Mô tả |
|------|-------|
| [01-dashboard.md](admin/01-dashboard.md) | Tổng quan, biểu đồ doanh thu, bộ lọc preset tuần/tháng/quý/năm, conversion funnel, lock screen |
...
| [04-don-hang.md](admin/04-don-hang.md) | Quản lý đơn hàng, xác nhận chuyển khoản, VNPAY refund, in hóa đơn, hoàn trả |
...
| [12-cart-abandonment.md](admin/12-cart-abandonment.md) | Theo dõi giỏ hàng bỏ rơi & tỷ lệ chuyển đổi |
| [13-vi-dien-tu.md](admin/13-vi-dien-tu.md) | Quản lý ví điện tử: duyệt nạp tiền, duyệt rút tiền, điều chỉnh thủ công |
...
├── Admin Panel               → /admin prefix + Controllers/Admin/ (27 controllers)
├── API Layer                 → Controllers/Api/ (3 controllers)
├── Services/                 → ChatService, VnpayService, OrderService, ReportService,
│                                ConversionTrackingService, ReturnService, ShippingService, WalletService
└── Database                  → 34 Models, MySQL
```
...
| **Đơn hàng** | `Order`, `OrderItem`, `OrderHistory`, `OrderReturnRequest` |
| **Giỏ hàng** | `CartAbandonment` |
| **Khuyến mãi** | `Coupon` |
| **Kho hàng** | `Supplier` |
| **Thanh toán** | `BankSetting`, `UserBankAccount` |
| **Ví điện tử** | `WalletTopupRequest`, `WalletTransaction`, `WalletWithdrawRequest` |
