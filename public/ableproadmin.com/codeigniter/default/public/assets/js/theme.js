...
function layout_change(layout) {
  ...
  if (layout === 'dark') {
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', '../assets/images/logo-white.html');
    updateLogo('.navbar-brand .logo-lg', '../assets/images/logo-white.html');
    updateLogo('.auth-main.v1 .auth-sidefooter img', '../assets/images/logo-white.html');
    updateLogo('.footer-top .footer-logo', '../assets/images/logo-white.html');
    ...
    updateLogo('.pc-sidebar .m-header .logo-lg', '../assets/images/logo-dark.html');
    updateLogo('.navbar-brand .logo-lg', '../assets/images/logo-dark.html');
    updateLogo('.auth-main.v1 .auth-sidefooter img', '../assets/images/logo-dark.html');
    updateLogo('.footer-top .footer-logo', '../assets/images/logo-dark.html');
