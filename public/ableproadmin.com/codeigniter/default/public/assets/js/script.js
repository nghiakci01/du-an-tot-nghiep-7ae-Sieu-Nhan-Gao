...
function setLayout() {
  ...
  if (layout !== null && layout !== '') {
    ...
    if (layout === 'horizontal') {
      ...
      script.src = 'assets/js/layout-horizontal.html'; // Load script for horizontal layout
      document.body.appendChild(script);
    } else if (layout === 'color-header') {
      // Change logo color for color-header layout
      if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
        document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', 'assets/images/logo-white.html');
      }
    } else if (layout === 'compact') {
      script.src = 'assets/js/layout-compact.html'; // Load script for compact layout
      document.body.appendChild(script);
    } else if (layout === 'tab') {
      script.src = 'assets/js/layout-tab.html'; // Load script for tab layout
      document.body.appendChild(script);
    }
  }
...
for (var t = 0; t < tc.length; t++) {
  tc[t].setAttribute('src', 'assets/images/logo-white.html');
}
