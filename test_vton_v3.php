<?php
// Standalone VTON Test Script v3
...
echo "Starting VTON Test v3 (Real Images)...\n";
...
echo "Sending request with real images...\n";
try {
    $response = Http::timeout(30)->post($url, $payload);
    echo "Initial Response: " . $response->status() . "\n";
    ...
    if ($eventId) {
        ...
        echo "No Event ID. Body: " . $response->body() . "\n";
    }
} catch (\Exception $e) {
